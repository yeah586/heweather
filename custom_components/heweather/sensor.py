...
OPTIONS = {
    ...
    "text": ["heweather_text", "天气描述", "mdi:thermometer", None],
    "precip": ["heweather_precip", "小时降水量", "mdi:weather-rainy", UnitOfVolumetricFlux.MILLIMETERS_PER_HOUR],
    "windDir": ["heweather_winddir", "风向", "mdi:windsock", None],
    ...
    "dew": ["heweather_dew", "露点温度", "mdi:thermometer-water", UnitOfTemperature.CELSIUS],
    ...
    "primary": ["heweather_primary", "空气质量的主要污染物", "mdi:weather-dust", None],
    ...
    "disaster_warn": ["heweather_disaster_warn", "灾害预警", "mdi:alert", None],

    "air": ["suggestion_air", "空气污染扩散条件指数", "mdi:air-conditioner", None],
    "comf": ["suggestion_comf", "舒适度指数", "mdi:human-greeting", None],
    "cw": ["suggestion_cw", "洗车指数", "mdi:car", None],
    "drsg": ["suggestion_drsg", "穿衣指数", "mdi:hanger", None],
    "flu": ["suggestion_flu", "感冒指数", "mdi:biohazard", None],
    "sport": ["suggestion_sport", "运动指数", "mdi:badminton", None],
    "trav": ["suggestion_trav", "旅行指数", "mdi:wallet-travel", None],
    "uv": ["suggestion_uv", "紫外线指数", "mdi:sun-wireless", None],
    "guomin": ["suggestion_guomin", "过敏指数", "mdi:sunglasses", None],
    "kongtiao": ["suggestion_kongtiao", "空调开启指数", "mdi:air-conditioner", None],
    "sunglass": ["suggestion_sunglass", "太阳镜指数", "mdi:sunglasses", None],
    "fangshai": ["suggestion_fangshai", "防晒指数", "mdi:shield-sun-outline", None],
    "liangshai": ["suggestion_liangshai", "晾晒指数", "mdi:tshirt-crew-outline", None],

    "jiaotong": ["suggestion_jiaotong", "交通指数", "mdi:train-car", None],
